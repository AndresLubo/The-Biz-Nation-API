...
const genreAudiovisualContent_controller_1 = require("../modules/genre-audiovisual_content/genreAudiovisualContent.controller");
const RouterApi = (app) => {
    ...
    router.use('/movies', audiovisualContent_controller_1.audiovisualContentController);
    router.use('/genres', genre_controller_1.genreController);
    router.use('/collaborations', collaboration_controller_1.collaborationController);
    router.use('/genres-movies', genreAudiovisualContent_controller_1.genreAudiovisualContentController);
